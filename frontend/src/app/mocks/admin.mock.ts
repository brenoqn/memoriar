...
export function mockAdminCemeteries(): Cemetery[] {
  return [
    {
...
export function mockAdminOverview(): AdminOverview {
  return {
    cemeteries_count: 1,
    burial_locations_count: 5,
    burial_cases_published_count: 4,
    burial_cases_in_review_count: 1,
    burial_cases_not_found_precisely_count: 1
  };
}

export function mockAdminSectors(): AdminSectorListItem[] {
  return [
    {
...
export function mockAdminQuadras(): AdminQuadraListItem[] {
  return [
    {
...
export function mockAdminBurialLocationTypes(): BurialLocationType[] {
  return [
    {
...
export function mockAdminBurialLocations(): AdminBurialLocationListItem[] {
  return [
    {
      ...
      alley_id: null,
      type_id: 'a62d2f9c-6d20-48f1-a896-67b8c1f15ca7',
    ...
    },
    {
      ...
      quadra_id: MOCK_ADMIN_IDS.quadraQ1Id,
      alley_id: null,
      type_id: 'd4d07d6d-443d-44c4-86b7-5f1d26a3a387',
      parent_location_id: null,
      map_node_id: '3b8dbd69-e31a-4d29-9256-4c5c0d9e9b51',
      code: 'Q1-GV-04',
      label: 'Gaveta 4',
    ...
    },
    {
      ...
      alley_id: null,
      type_id: 'c0b8d5f7-5af6-4b7e-a6f6-0701e0cf1d80',
      parent_location_id: null,
...
export function mockAdminBurialCases(): AdminBurialCaseListItem[] {
  return [
    {
...
export function mockAdminRemainsMovements(): AdminRemainsMovementListItem[] {
  return [
    {
...
export function mockAdminDataQuality(): AdminDataQualityResponse {
  return {
    ...
    summary: { issues_total: 4, critical: 1, warning: 2, info: 1 }
  };
}
